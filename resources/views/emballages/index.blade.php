<x-app-layout>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <h2 class="text-center text-white text-lg p-10">La liste des emballages</h2>
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <button id="b2"><a href="{{route('emballages.edit' ,$e->id_type)}}">
                    ...
                    <td class="px-6 py-4">
                        <button id="b3"><a href="{{route('emballages.show' ,$e->id_type)}}">
