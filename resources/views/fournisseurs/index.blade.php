...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="flex justify-end">
            <button class="bg-green-700 p-2 rounded-lg text-white font-bold hover:bg-green-900"  id="b0" type="submit"><a href="{{ route('depots.create') }}">Ajouter un fournisseur</a></button>
        </div>
        <hr class="h-1 mt-2 mb-3">
        <h1 class="text-center text-white text-lg p-10" >La liste des fournisseurs</h1>
        ...
        <tbody>
            @forelse($listfournisseur as $fournisseur) 
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td scope="col" class="px-6 py-3">
                        <button id="b2"><a href="{{route('fournisseurs.edit' ,$fournisseur->id_fournisseur)}}">
                    ...
                    <td scope="col" class="px-6 py-3">
                        <button id="b3"><a href="{{route('fournisseurs.show' ,$fournisseur->id_fournisseur)}}">
            ...
            @empty
            <p class="text-white text-lg mb-4">Aucun fournisseur existant</p>
            @endforelse
        </tbody>
    </table>
    </form>
