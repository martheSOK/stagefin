            ...
            <tbody>
              @forelse($listePersonnel as $personnel)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td>
                        <button id="b2"><a href="{{route('personnels.edit' ,$personnel->id_personnel)}}">
                    ...
                    <td>
                        <button id="b3"><a href="{{route('personnels.show' ,$personnel->id_personnel)}}">
                ...
                @empty
                    <p class="text-white text-lg mb-4">Aucun personnel existante</p>
                @endforelse
